...
- add flag for removing screenshots after parsing them
...
# Table of Content
- [foxhole\_stockpile\_scanner](#foxhole_stockpile_scanner)
...
- [Usage](#usage)
  - [Initial configuration](#initial-configuration)
    - [Usage on secondary screens](#usage-on-secondary-screens)
  - [Launching the script.](#launching-the-script)
- [Parametrisation.](#parametrisation)
  - [params.toml](#paramstoml)
  - [source/locations\_file/\*](#sourcelocations_file)
  - [config.py](#configpy)
